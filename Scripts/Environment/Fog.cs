...
public partial class Fog : Sprite2D
{
    ...
    public override void _PhysicsProcess(double delta) => UpdateFog(player?.Position ?? new Vector2(0,0) / gridSize);
    //public override void _PhysicsProcess(double delta) => UpdateFog(GetViewport().GetMousePosition() / gridSize);
